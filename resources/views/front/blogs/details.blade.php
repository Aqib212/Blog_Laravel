                    ...
                    <div class="border rounded bg-white">
                        ...
                        <div class="p-4">
                            ...
                            <ul class="list-inline d-block pb-4 border-bottom mb-3">
                                <li class="list-inline-item text-color">Posted By </li>
                                <li class="list-inline-item text-color">On {{ $blog->updated_at->format('d M') }}</li>
                            </ul>
                                ...
                                <div class="d-flex py-3 border-bottom">
                                    <div class="mr-4">
                                        <a href="{{ route('blog-details',['slug' => $recentblog->slug]) }}">
                                            <img class="rounded" src="{{ asset($recentblog->image) }}" alt="post-thumb" style="height: 69px; width: 69px;">
                                        </a>
                                    </div>
                                    <div>
                                        <h6 class="mb-3">
                                            <a class="text-dark" href="{{ route('blog-details',['slug' => $recentblog->slug]) }}">{{ $recentblog->blog_title }}</a>
                                        </h6>
                                        <p class="meta">{{ $recentblog->updated_at->format('d M, Y') }}</p>
                                    </div>
                                </div>
                            @endforeach
                        </div>
